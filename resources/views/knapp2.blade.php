...
<div class="form-group">
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      ...
      <option value="/knapp2" selected="selected">2. Matriks nama sistem informasi manajemen dan tingkat pemanfaatannya</option>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Nama Sistem Informasi Manajemen</th>
      <th scope="col">Deskripsi Singkat</th>
      <th scope="col">Perkembangan Penerapan</th>
    </tr>
  </thead>
  <tbody>
    <tr>
