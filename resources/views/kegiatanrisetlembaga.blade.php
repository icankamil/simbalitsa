...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/kegiatanrisetlembaga" selected="selected">3. Jumlah kegiatan yang mendukung pengembangan produk riset lembaga</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/kegiatanrisetlembaga" selected="selected">1. Matriks Kegiatan yang mendukung pengembangan produk riset lembaga</option></select>
  </div>
