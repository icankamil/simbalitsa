...
<div class="form-group">
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/jenisbelanja" selected="selected">1. Matriks komposisi berdasarkan jenis belanja</option>
      <option value="/sumberpenerimaan">2. Matriks komposisi anggaran berdasarkan sumber penerimaan</option>
    </select>
  </div>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      ...
      <th scope="col">Jumlah Pagu (Rp.) </th>
      <th scope="col">Jumlah Realisasi (Rp.)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
