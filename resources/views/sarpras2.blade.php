...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/tingkatsarpras" selected="selected">3. Tingkat pemanfaatan dan ketersediaan dukungan sarana dan prasarana</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/tingkatsarpras">1. Matriks nama SOP dan tingkat pemanfaatannya</option>
      <option value="/sarpras2" selected="selected">2. Matriks nama sistem informasi manajemen dan tingkat pemanfaatannya</option>
    </select>
  </div>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Sarpras Utama non Riset</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>


 <div class="form-group">
    <label for="exampleFormControlTextarea1" class="bmd-label-floating">Akses Penggunaan</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="5"></textarea>
  </div>

  <div class="form-group">
    <label for="exampleFormControlTextarea1" class="bmd-label-floating">Kondisi Sarpras Riset</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="5"></textarea>
  </div>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Nama Sarpras Utama non Riset</th>
      <th scope="col">Akses Penggunaan</th>
      <th scope="col">Kondisi Sarpras non Riset</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td>Kebun Percobaan</td>
      <td>Lorem Ipsum Dolor sit amet</td>
      <td>Kebun percobaan 2 kondisi dan lain sebagainya</td>
    </tr>
  </tbody>
</table>
