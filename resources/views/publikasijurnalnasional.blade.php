...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/publikasijurnalnasional" selected="selected">4. Publikasi dalam jurnal nasional terakreditasi (Min:20)</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/publikasijurnalnasional" selected="selected">1. Matriks rekapitulasi perolehan publikasi dalam jurnal ilmiah nasional terakreditasi</option></select>
  </div>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Judul Publikasi dalam jurnal ilmiah nasional terakreditasi</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Peneliti-Perekayasa</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Jurnal, Volume-Tahun</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Judul Publikasi dalam jurnal ilmiah nasional terakreditasi</th>
      <th scope="col">Nama Peneliti-Perekayasa</th>
      <th scope="col">Nama Jurnal, Volume-Tahun</th>
