...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      <option value="/absorptive/">1. Tingkat Kualitas Tata Kelola Organisasi dan perolehan Sertifikasi KNAPPP</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      ...
      <option value="/knapp3" selected="selected">3. Matriks perkembangan perolehan akreditasi KNAPP</option>
    </select>
  </div>
...
<div class="form-group">
 ...
 <div class="form-group">
  ...
  <!--<div class="form-group">
    <label for="exampleFormControlTextarea1" class="bmd-label-floating">Perkembangan Penerapan SOP</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="5"></textarea>
  </div>-->
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      ...
      <th scope="col">Deskripsi Singkat SOP</th>
    </tr>
  </thead>
  <tbody>
    <tr>
