...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/nationalreference" >7. Perolehan apresiasi - national references bagi kinerja pusat unggulan</option>
      <option value="/economicbenefit" selected="selected">8. Perolehan economic benefit atau social impact bagi masyarakat</option>
    </select>
  </div>

  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/nationalreference" >1. Matriks economic benefit dan atau social impact atas pemanfaat produk unggulan lembaga</option></select>
  </div>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Produk Unggulan</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Deskripsi Singkat</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Informasi terjadinya economic impact/social impact</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Nama Produk Unggulan</th>
      <th scope="col">Deskripsi Singkat</th>
      <th scope="col">Informasi terjadinya economic impact/social impact</th>
    </tr>
  </thead>
  <tbody>
    <tr>
