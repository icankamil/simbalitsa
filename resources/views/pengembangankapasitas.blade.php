...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/pengembangankapasitas" selected="selected">7. Jumlah kegiatan pengembangan kapasitas riset (SDM dan Sarpras)</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/pengembangankapasitas" selected="selected">1. Matriks kegiatan pengembangan kapasitas riset</option>
    </select>
  </div>
...
<div class="form-group">
  ...
  <div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Waktu Pelaksanaan</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
...
<table class="table table-bordered table-light">
  ...
  <tbody>
    <tr>
      ...
      <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In eu vestibulum ex. Maecenas iaculis ornare libero, commodo mattis orci suscipit a. Aenean laoreet, eros at accumsan porta, tortor ligula placerat elit, sit amet congue tellus est eu ex.</td>
    </tr>
    <tr>
      <th scope="row">2</th>
      <td>Lorem Ipsum dolor sit amet</td>
