...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/penguatanproduk" selected="selected">3. Jumlah kegiatan yang mendukung penguatan produk riset lembaga</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/penguatanproduk" selected="selected">1. Matriks Kegiatan yang mendukung penguatan produk riset lembaga</option></select>
  </div>
