...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/kerjasamarisetnasional" selected="selected">7. Kerjasama riset pada tingkat nasional (Min:3)</option>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Kerjasama Riset Nasional</label>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Nama Kerjasama Riset Nasional</th>
