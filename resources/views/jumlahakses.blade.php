...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/kapasitaslembaga" selected="selected">6. Kapasitas lembaga dalam pengembangan jaringan dan akses informasi</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/kapasitaslembaga" >1. Jaringan Peneliti pada himpunan masyarakat ilmiah internasional</option>
      <option value="/jumlahakses" selected="selected">2. Jumlah akses ke jurnal ilmiah online nasional dan internasional</option>
      <option value="/jumlahlayanan">3. Jumlah layanan yang tersedia melalui sistem informasi lembaga</option>
    </select>
  </div>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Jurnal Ilmiah Online</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>


  <div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Deskripsi Singkat:Lingkup Substansi</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Keterangan-Informasi Lainnya</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
...
<h4 class="font-weight-bold text-primary my-3 mt-5"><u>Jumlah akses ke jurnal ilmiah online nasional dan internasional</u></h4>
<div class="row no-gutters">
<div class="col-6">
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Nama Jurnal Ilmiah Online</th>
      <th scope="col">Deskripsi Singkat:lingkup substansi</th>
      <th scope="col">Keterangan-informasi lainnya</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td>Jurnal Hortikultura</td>
      <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In eu vestibulum ex. Maecenas iaculis ornare libero, commodo mattis orci suscipit a.</td>
      <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In eu vestibulum ex. Maecenas iaculis ornare libero, commodo mattis orci suscipit a.</td>
    </tr>
  </tbody>
</table>
