...
<div class="form-group">
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      ...
      <option value="/sitasikumulatif" >3. Jumlah Sitasi Kumulatif Lembaga</option>
      <option value="/skpenugasan" selected="selected">4. Jumlah SK penugasan nasional tahun berjalan</option>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Judul SK</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Instansi yang mengeluarkan</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>

  <div class="form-group">
    <label for="exampleFormControlTextarea1" class="bmd-label-floating">Deskripsi Penugasan</label>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      ...
      <th scope="col">Instansi yang mengeluarkan</th>
      <th scope="col">Deskripsi penugasan</th>
    </tr>
  </thead>
  <tbody>
    <tr>
