...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      <option value="/penguatanbasisdata" selected="selected">1. Jumlah Kegiatan yang mendukung basis data dan informasi</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/penguatanbasisdata" selected="selected">1. Matriks Kegiatan yang mendukung penguatan basis data dan informasi produk unggulan lembaga</option></select>
  </div>
