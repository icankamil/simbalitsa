...
<div class="form-group">
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      ...
      <option value="/jumlahlayanan" selected="selected">3. Jumlah layanan yang tersedia melalui sistem informasi lembaga</option>
    </select>
  </div>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Layanan</label>
