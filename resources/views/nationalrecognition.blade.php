...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/nationalrecognition" selected="selected">6. Perolehan apresiasi national recognition untuk produk berbasis riset</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/nationalrecognition" selected="selected">1. Matriks perolehan apresiasi nasional atau internasional recognition atas produk unggulan</option></select>
  </div>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Apresiasi-Penghargaan</label>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Nama Apresiasi-Penghargaan</th>
