...
<div class="form-group">
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      ...
      <option value="/sarpras2">2. Matriks nama sistem informasi manajemen dan tingkat pemanfaatannya</option>
    </select>
  </div>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Sarpras Utama Riset</label>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Nama Sarpras Utama Riset</th>
      <th scope="col">Akses Penggunaan</th>
      <th scope="col">Kondisi Sarpras Riset</th>
    </tr>
  </thead>
  <tbody>
    <tr>
