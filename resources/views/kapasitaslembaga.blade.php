...
<div class="form-group">
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/kapasitaslembaga" selected="selected">1. Jaringan Peneliti pada himpunan masyarakat ilmiah internasional</option>
      <option value="/jumlahakses" >2. Jumlah akses ke jurnal ilmiah online nasional dan internasional</option>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Himpunan Masyarakat Ilmiah Internasional</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>


  <div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Jumlah Peneliti-Perekayasa yang terlibat</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
...
<h4 class="font-weight-bold text-primary my-3 mt-5"><u>Jaringan peneliti pada himpunan masyarakat ilmiah internasional</u></h4>
<div class="row no-gutters">
<div class="col-6">
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Nama Himpunan Masyarakat Internasional</th>
      <th scope="col">Jumlah Peneliti-Perekayasa yang terlibat</th>
