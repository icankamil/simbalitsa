...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/kontrakbisnis" selected="selected">5. Kontrak bisnis dengan industri dalam rangka hilirisasi produk unggulan</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/kontrakbisnis" selected="selected">1. Matriks rekapitulasi kontrak bisnis</option></select>
  </div>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Kontrak Bisnis</label>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Nama Kontrak Bisnis</th>
