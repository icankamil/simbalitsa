...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/perolehanpaten" selected="selected">6. Perolehan paten atau rezim HKI lainnya</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/perolehanpaten" selected="selected">1. Matriks Perolehan Paten atau rezim HKI lainnya</option></select>
  </div>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Perlindungan HKI (Paten, PVT, Rezim HKI lainnya)</label>
  ...
  <div class="form-group">
    <label for="exampleFormControlTextarea1" class="bmd-label-floating">Keterangan-Informasi Lainnya</label>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Nama Perlindungan HKI (Paten, PVT, Rezim HKI lainnya)</th>
