...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/hilirisasi" selected="selected">2. Jumlah kegiatan yang mendukung peningkatan kerjasama hilirisasi produk</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/hilirisasi" selected="selected">1. Matriks Kegiatan yang mendukung peningkatan kerjasama hilirisasi produk</option></select>
  </div>
