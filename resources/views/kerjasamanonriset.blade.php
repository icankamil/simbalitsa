...
<div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="indikator">
      ...
      <option value="/kerjasamanonriset" selected="selected">4. Kerjasama non riset (jasa konsultasi, diklat, dll) dengan pengguna teknologi</option>
  ...
  <div class="form-group">
    <select class="form-control selectpicker" data-style="btn btn-link" id="subindikator">
      <option value="/kerjasamanonriset" selected="selected">1. Matriks rekapitulasi kerjasama non riset</option></select>
  </div>
...
<div class="form-group">
    <label for="exampleInputEmail1" class="bmd-label-floating">Nama Kerjasama non riset</label>
...
<table class="table table-bordered table-light">
  <thead class="bg-primary">
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Nama Kerjasama Non Riset</th>
